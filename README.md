...
| | | |
|:-------------------------:|:-------------------------:|:-------------------------:|
| <img width="400" alt="screen shot pm" src="./screens/screen-home-mobile.png">  Home | <img width="400" alt="screen shot pm" src="./screens/screen-home-mobile-search.png">  Home Pesquisa | 
| <img width="400" alt="screen shot pm" src="./screens/screen-register-mobile.png">  Cadastro | <img width="400" alt="screen shot pm" src="./screens/screen-update-mobile.png">  Alteração | <img width="400" alt="screen shot pm" src="./screens/screen-home-expanded-item-mobile.png">  Home Expandido | 
